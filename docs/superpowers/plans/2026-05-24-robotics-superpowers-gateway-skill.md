# Robotics Superpowers Gateway Skill Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a `robotics-superpowers` gateway skill that auto-triggers on robotics topics and routes to correct specialized skills.

**Architecture:** Single new skill file with Red Flags table and decision routing, plus minor updates to `using-superpowers` and README for integration.

**Tech Stack:** Markdown skill files

---

### Task 1: Create robotics-superpowers Gateway Skill

**Files:**
- Create: `skills/robotics-superpowers/SKILL.md`

- [ ] **Step 1: Create skill directory**

```bash
mkdir -p skills/robotics-superpowers
```
...
```bash
ls -la skills/robotics-superpowers/SKILL.md
head -5 skills/robotics-superpowers/SKILL.md
```

- [ ] **Step 4: Commit**

```bash
git add skills/robotics-superpowers/SKILL.md
git commit -m "Create robotics-superpowers gateway skill"
```

---

### Task 2: Add robotics-superpowers to using-superpowers Domain Skills

**Files:**
- Modify: `skills/using-superpowers/SKILL.md`

- [ ] **Step 1: Read current Domain-Specific Skills section**

Read `skills/using-superpowers/SKILL.md` around line 115 to find the Domain-Specific Skills section.

- [ ] **Step 2: Add robotics-superpowers to the list**

Insert this line in the Robotics & Automation subsection, at the top (before ros-robotics-expert):
...
Read the modified section to confirm the addition is correct.

- [ ] **Step 4: Commit**

```bash
git add skills/using-superpowers/SKILL.md
git commit -m "Add robotics-superpowers to domain skills list in using-superpowers"
```

---

### Task 3: Update README Robotics Skills Section

**Files:**
- Modify: `README.md`

- [ ] **Step 1: Read current Robotics Skills section**

Read `README.md` around line 142 to find the Robotics Skills section.

- [ ] **Step 2: Add gateway skill intro**

Insert this paragraph immediately after the "## Robotics Skills" heading (before the skill list):
...
Read the modified section to confirm the addition reads well.

- [ ] **Step 4: Commit**

```bash
git add README.md
git commit -m "Add robotics-superpowers gateway skill mention to README"
```
...
**Files:**
- Review: `skills/robotics-superpowers/SKILL.md`
- Review: `skills/using-superpowers/SKILL.md`
- Review: `README.md`

- [ ] **Step 1: Verify all files are consistent**

Check that:
- `robotics-superpowers` skill has valid YAML frontmatter
- All 7 specialized skills are listed in the decision table
- `using-superpowers` references `robotics-superpowers`
- README mentions the gateway skill
...
```bash
git add docs/superpowers/plans/2026-05-24-robotics-superpowers-gateway-skill.md
git commit -m "Add implementation plan for robotics-superpowers gateway skill"
```
